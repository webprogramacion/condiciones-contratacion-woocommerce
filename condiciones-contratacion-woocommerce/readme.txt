...
= 1.2.0 =
* Añadida la dirección IP desde la que el cliente acepta cada condición: se guarda en el pedido y se muestra junto a la fecha en el panel «Condiciones aceptadas» del administrador.
* El plugin se distribuye ahora desde un directorio propio en el repositorio, lo que simplifica las implantaciones manuales y hace que el zip de las releases se pueda instalar directamente. Sin cambios de comportamiento en la tienda.
...
= 1.2.0 =
Registra la IP desde la que el cliente acepta cada condición, como evidencia adicional del consentimiento. Los pedidos anteriores no se modifican.
